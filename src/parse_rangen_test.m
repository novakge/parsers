...
% example#1: results = run(parse_rangen_test)
% example#2: runtests('parse_rangen_test')

function tests = parse_rangen_test
...
[i1,i2,i3,i4,i5,i6] = indicators(parse_rangen(testCase.TestData.PAT101,0));
...
[i1,i2,i3,i4,i5,i6] = indicators(parse_rangen(testCase.TestData.PAT80,0));
actSolution = [i1,i2,i3,i4,i5,i6];
...
[i1,i2,i3,i4,i5,i6] = indicators(parse_rangen(testCase.TestData.PAT_OWN01,0));
actSolution = [i1,i2,i3,i4,i5,i6];
...
[i1,i2,i3,i4,i5,i6] = indicators(parse_rangen(testCase.TestData.PAT_OWN02,0));
actSolution = [i1,i2,i3,i4,i5,i6];
...
[i1,i2,i3,i4,i5,i6] = indicators(parse_rangen(testCase.TestData.PAT_OWN03,0));
actSolution = [i1,i2,i3,i4,i5,i6];
...
[i1,i2,i3,i4,i5,i6] = indicators(parse_rangen(testCase.TestData.RG300_120,0));
actSolution = [i1,i2,i3,i4,i5,i6];
...
[i1,i2,i3,i4,i5,i6] = indicators(parse_rangen(testCase.TestData.RG300_10,0));
actSolution = [i1,i2,i3,i4,i5,i6];
