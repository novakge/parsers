...
% example: PDM = parse_instance('test_data/pat80.rcp', 2) where 1=NTP, 2=CTP, 3=DTP simulation type
% output: PDM file containing PDM = [DSM,TD,CD,{QD,RD}], format depending on the selected simulation type (trade-off problem)

function [PDM, constr, num_r_resources, num_modes] = parse_instance(file_name, sim_type)
